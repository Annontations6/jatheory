...
var getPublicationMultiplier = (tau) => tau.pow(0.174) / BigNumber.THREE;
var getPublicationMultiplierFormula = (symbol) => "\\frac{{" + symbol + "}^{0.174}}{3}";
var getTau = () => currency.value.pow(0.6);
var get2DGraphValue = () => currency.value.sign * (BigNumber.ONE + currency.value.abs()).log10().toNumber();

var getA1 = (level) => BigNumber.ZERO;
var getA2 = (level) => BigNumber.ZERO;
var getA3 = (level) => BigNumber.ZERO;
var getA4 = (level) => BigNumber.ZERO;
var getA5 = (level) => BigNumber.ZERO;
var getA6 = (level) => BigNumber.ZERO;
var getA7 = (level) => BigNumber.ZERO;
var getA8 = (level) => BigNumber.ZERO;
var getA9 = (level) => BigNumber.ZERO;
